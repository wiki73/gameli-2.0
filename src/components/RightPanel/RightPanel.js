...
const RightPanel = () => {
  ...
  return (
    <div className="RightPanel">
      ...
      {openModalWindowInvent ? <ModalInventory isOpen={openModalWindowInvent} onClose={() => setOpenModalWindowInvent(false)} /> : null}
      {openModalWindowList ? <ModalList isOpen={openModalWindowList} onClose={() => setOpenModalWindowList(false)} /> : null}
    </div>
  );
};
