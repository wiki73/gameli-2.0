  ...
  return (
    <>  
      ...
      {open ? <div className="modal-overlay" onClick={() => setOpen(false)}>
        <form className="ModalWindowAddTask" onClick={(e) => e.stopPropagation()} onSubmit={handleSubmit} >
          <input className='text-input' name="description" onBlur={() => isFocusedRef.current =false} onFocus={() => isFocusedRef.current = true} ref={inputRef} tabIndex={1} type="text" />
